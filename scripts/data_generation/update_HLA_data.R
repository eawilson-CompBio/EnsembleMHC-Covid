...
#This HLA scrapper was heavily adapted from https://github.com/pdxgx/covid19/blob/master/src/HLA_frequencies.R
#major changes are this runs multicore and is focused on pulling the data need for EnsembleMHC population score
